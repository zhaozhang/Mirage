...
if __name__ == '__main__':
    ...
    mixture_validation_tensor_input = mixture_validation_tensor_input.to('cpu' if DEVICE == 'cpu' else 'cuda')
    mixture_validation_tensor_target = mixture_validation_tensor_target.to('cpu' if DEVICE == 'cpu' else 'cuda')
    ...
    MOE_VALIDATION_BATCH_SIZE = 2048
