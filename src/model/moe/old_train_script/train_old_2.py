...
if __name__ == '__main__':
    ...
    for iexpert in range(NUM_EXPERTS):
        ...
        if (MODEL_NAME == 'linear'):
            predictor = Predictor(model_name='linear', hparams=LINEAR_NEURAL_REGRESSOR_CONFIG, optimizer_name='Adam',
                                  base_learning_rate=EXPERT_TRAIN_LR[iexpert], device='gpu')
    ...
    moe_predictor = Predictor(model_name='moe', hparams=model_hparams, optimizer_name='Adam', base_learning_rate=1e-7,
                              device='gpu')
